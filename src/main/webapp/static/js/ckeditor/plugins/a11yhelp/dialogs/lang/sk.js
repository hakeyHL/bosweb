    ...
    },
        {
            ...
            items: [{name: "Vrátiť príkazy", legend: "Stlačte ${undo}"}, {
            ...
            },
                {
                    ...
                    legend: "Stlačte ${accessNextSpace} pre prístup na najbližšie nedosiahnuteľné zamerateľné medzery model vsuvke. Napríklad: dve za sebou idúce horizontálne čiary. Opakujte kombináciu klávesov pre dosiahnutie vzdialených zamerateľných medzier."
