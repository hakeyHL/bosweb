    ...
    },
        {
            ...
            items: [{name: " Příkaz Zpět", legend: "Stiskněte ${undo}"}, {
            ...
            },
                {
                    ...
                    legend: "Stiskněte ${accessNextSpace} pro přístup k nejbližšímu nedosažitelnému prostoru zaměření model stříšce, například: dva přilehlé prvky HR. Pro dosažení vzdálených prostorů zaměření tuto kombinaci kláves opakujte."
