...
(function () {
    function z() {
        var a, b = arguments, c, d = {}, e = function (a, b) {
            ...
            typeof a !== "object" && (a = {});
            for (d in b) {
                b.hasOwnProperty(d) && (c = b[d], a[d] =
                    c && typeof c === "object" && Object.prototype.toString.call(c) !== "[object Array]" && d !== "renderTo" &&
                    typeof c.nodeType !== "number" ? e(a[d] || {}, c) : b[d]);
            }
            return a
        };
    ...
    function Ja(a, b) {
        for (var c = "{", d = !1, e, f, g, h, i, j = []; (c = a.indexOf(c)) !== -1;) {
            ...
            if (d) {
                ...
                if (f.length) {
                    f = f.join(":"), g = /\.([0-9])/, h = T.lang, i = void 0, /f$/.test(f) ?
                        (i = (i = f.match(g)) ? i[1] : -1, e !== null &&
                        (e = A.numberFormat(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : ""))) : e = Oa(f, e)
                }
            }
            j.push(e);
            a = a.slice(c + 1);
    ...
    var y, B = document, K = window, W = Math, r = W.round, V = W.floor, ta = W.ceil, u = W.max, C = W.min, O = W.abs, X = W.cos, aa = W.sin, ma = W.PI, ha = ma *
            2 / 360, Ba = navigator.userAgent, Jb = K.opera, ya = /(msie|trident)/i.test(Ba) && !Jb, hb = B.documentMode ===
            8, ib = /AppleWebKit/.test(Ba), La = /Firefox/.test(Ba), Kb = /(Mobile|Android|Windows Phone)/.test(Ba),
        Ca = "http://www.w3.org/2000/svg", ca = !!B.createElementNS && !!B.createElementNS(Ca, "svg").createSVGRect, Ob = La &&
            parseInt(Ba.split("Firefox/")[1], 10) < 4, fa = !ca && !ya && !!B.createElement("canvas").getContext, $a, ab, Lb = {}, yb = 0, fb, T, Oa, za, zb, E, na = function () {
            return y
        }, Y = [], bb = 0, Ka = "div", P = "none", Pb = /^[0-9]+$/, jb = ["plotTop",
            "marginRight", "marginBottom",
            "plotLeft"], Qb = "stroke-width", Aa, gb, ob, eb, sb, tb, ub, Xa, Ya, Za, Eb, Fb, Gb, Hb, vb, wb, xb, M = {}, A;
    ...
    Oa = function (a, b, c) {
        ...
        var a = p(a, "%Y-%m-%d %H:%M:%S"), d = new Aa(b -
            Wa(b)), e, f = d[tb](), g = d[ub](), h = d[Xa](), i = d[Ya](), j = d[Za](), k = T.lang, l = k.weekdays, d = x({
            a: l[g].substr(0, 3),
            A: l[g],
            d: Ia(h),
            e: h,
    ...
    A.numberFormat = function (a, b,
                               c, d) {
        var e = T.lang, a = +a || 0, f = b === -1 ? C((a.toString().split(".")[1] || "").length, 20) : isNaN(b = O(b)) ? 2 : b, b = c === void 0 ? e.decimalPoint : c, d = d === void 0 ? e.thousandsSep : d, e = a < 0 ? "-" : "", c = String(D(a =
            O(a).toFixed(f))), g = c.length > 3 ? c.length % 3 : 0;
        return e + (g ? c.substr(0, g) + d : "") + c.substr(g).replace(/(\d{3})(?=\d)/g, "$1" + d) +
            (f ? b + O(a - c).toFixed(f).slice(2) : "")
    };
    zb = {
        init: function (a, b, c) {
            ...
            if (b.length) {
                for (a = c.length; b.length < a;) {
                    ...
                    (d[f - 6] = d[f - 2], d[f - 5] = d[f - 1]), b = b.concat(d);
                }
            }
                ...
                init: function (b) {
                    ...
                    a.each(["cur", "_default", "width", "height", "opacity"], function (b, e) {
                        ...
                        (g = f[e]) && (f[e] = function (a) {
                            var c, a = b ? a : this;
                            if (a.prop !== "align") {
                                return c = a.elem, c.attr ? c.attr(a.prop, e === "cur" ? y : a.now) : g.apply(this,
                                        arguments)
                            }
                        })
                    });
                    ...
                    a.fn.highcharts = function () {
                        ...
                        if (this[0]) {
                            ...
                            c = b[0];
                            if (c !== y) {
                                c.chart = c.chart || {}, c.chart.renderTo = this[0], new A[a](c, b[1]), g = this;
                            }
        ...
        Wb = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/, oa = function (a) {
            ...
            (function (a) {
                a && a.stops ? d = Ua(a.stops, function (a) {
                    ...
                    (c = Ub.exec(a)) ? b = [D(c[1]), D(c[2]), D(c[3]), parseFloat(c[4], 10)] :
                        (c = Vb.exec(a)) ? b = [D(c[1], 16), D(c[2], 16), D(c[3], 16), 1] :
                            (c = Wb.exec(a)) && (b = [D(c[1]), D(c[2]), D(c[3]), 1])
            })(a);
            return {
                get: function (c) {
                    var f;
    ...
    Q.prototype = {
        ...
        colorGradient: function (a, b, c) {
            ...
            if (f) {
                ...
                v = v.join(",");
                h[v] ? a = h[v].attr("id") :
                    (g.id = a = "highcharts-" + yb++, h[v] = i = d.createElement(f).attr(g).add(d.defs), i.stops = [], o(j,
                        function (a) {
        ...
        applyTextShadow: function (a) {
            ...
            f ? L(b, e) : (this.fakeTS = !0, this.ySetter = this.xSetter, c =
                    [].slice.call(b.getElementsByTagName("tspan")), o(a.split(/\s?,\s?/g), function (a) {
                    var d = b.firstChild, e, f, a = a.split(" ");
                    e = a[a.length - 1];
                    (f = a[a.length - 2]) && o(c, function (a, c) {
                        var g;
                        c === 0 &&
                        (a.setAttribute("x", b.getAttribute("x")), c = b.getAttribute("y"), a.setAttribute("y", c || 0), c === null &&
                        b.setAttribute("y", 0));
                        g = a.cloneNode(1);
                        J(g, {
        ...
        updateShadows: function (a, b) {
            for (var c = this.shadows, d = c.length; d--;) {
                c[d].setAttribute(a, a === "height" ? u(b - (c[d].cutHeight ||
                        0), 0) : a === "d" ? this.d : b)
            }
        },
        addClass: function (a) {
        ...
        updateTransform: function () {
            var a = this.translateX || 0, b = this.translateY ||
                0, c = this.scaleX, d = this.scaleY, e = this.inverted, f = this.rotation, g = this.element;
        ...
        align: function (a, b, c) {
            ...
            if (a) {
                if (this.alignOptions = a, this.alignByTranslate = b, !c || Da(c)) {
                    this.alignTo = d = c || "renderer", ja(f,
            ...
            if (!b) {
                if (f.namespaceURI === Ca || c.forExport) {
                    try {
                        ...
                        j.textShadow ? (i = j.textShadow, j.textShadow = "") : k && k(P), b =
                            f.getBBox ? x({}, f.getBBox()) : {
                                    width: f.offsetWidth,
                ...
                if (c.isSVG) {
                    ...
                    d = b.height;
                    if (ya &&
                        g && g.fontSize === "11px" && d.toPrecision(3) === "16.9") {
                        b.height = d = 14;
                    }
                    if (e) {
                        b.width = O(d * aa(h)) + O(a * X(h)), b.height = O(d * X(h)) + O(a * aa(h))
                    }
                }
                c.cache[l] = b
            }
        ...
        show: function (a) {
            a && this.element.namespaceURI === Ca ? this.element.removeAttribute("visibility") :
        ...
        destroy: function () {
            ...
            for (c && o(c, function (b) {
                ...
                b =
                    d.parentGroup, a.safeRemoveChild(d.div), delete d.div, d = b;
            }
        ...
        shadow: function (a, b, c) {
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    ...
                    if (c) {
                        J(f, "height", u(J(f, "height") - h, 0)), f.cutHeight = h;
                    }
        ...
        dashstyleSetter: function (a) {
            ...
            if (a = a && a.toLowerCase()) {
                a = a.replace("shortdashdotdot", "3,1,1,1,1,1,").replace("shortdashdot", "3,1,1,1").replace("shortdot",
                    "1,1,").replace("shortdash", "3,1,").replace("longdash", "8,3,").replace(/dot/g, "1,3,").replace("dash",
                    "4,3,").replace(/,$/,
                    "").split(",");
                for (b = a.length; b--;) {
        ...
        zIndexSetter: function (a, b) {
            ...
            if (e) {
                ...
                for (i = 0; i <
                d.length && !h; i++) {
                    if (e = d[i], f = J(e, "zIndex"), e !== g && (D(f) > a || !q(a) && q(f))) {
    ...
    Q.prototype.translateXSetter = Q.prototype.translateYSetter = Q.prototype.rotationSetter =
        Q.prototype.verticalAlignSetter = Q.prototype.scaleXSetter = Q.prototype.scaleYSetter = function (a, b) {
            this[b] = a;
            this.doTransform = !0
        };
    Q.prototype["stroke-widthSetter"] = Q.prototype.strokeSetter = function (a,
        ...
        if (this.stroke && this["stroke-width"]) {
            this.strokeWidth = this["stroke-width"], Q.prototype.fillSetter.call(this, this.stroke,
                "stroke", c), c.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = !0;
        } else if (b === "stroke-width" &&
            a === 0 && this.hasStroke) {
    ...
    ua.prototype = {
        ...
        init: function (a, b, c, d, e) {
            ...
            this.boxWrapper = d;
            this.alignedObjects = [];
            this.url = (La || ib) && B.getElementsByTagName("base").length ?
        ...
        buildText: function (a) {
            for (var b = a.element, c = this, d = c.forExport, e = p(a.textStr, "").toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, j = J(b, "x"), k = a.styles, l = a.textWidth, m = k && k.lineHeight, n = k &&
                k.textShadow, v = k && k.textOverflow === "ellipsis", s = g.length, S = l && !a.added && this.box, N = function (a) {
                return m ?
                    D(m) :
                    c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : k && k.fontSize || c.style.fontSize || 12,
                        a).h
            }, t = function (a) {
            ...
            !f && !n && !v && e.indexOf(" ") === -1 ? b.appendChild(B.createTextNode(t(e))) :
                (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, S && S.appendChild(b), e = f ?
                    e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g,
                        '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g,
                    ...
                    o(g, function (e) {
                        if (e !== "" || g.length === 1) {
                            ...
                            if (e !== " ") {
                                ...
                                if (l) {
                                    for (var n = e.replace(/([^\^])-/g, "$1- ").split(" "), o = g.length > 1 || f || n.length > 1 &&
                                        k.whiteSpace !==
                                        "nowrap", S, w, q, u = [], y = N(s), r = 1, x = a.rotation, z = e, C = z.length;
                                         (o || v) && (n.length || u.length);) {
                                        a.rotation = 0, S = a.getBBox(!0), q = S.width, !ca &&
                                        c.forExport && (q = c.measureSpanWidth(s.firstChild.data, a.styles)), S = q > l, w === void 0 &&
                                        (w = S), v && w ?
                                            (C /= 2, z === "" || !S && C < 0.5 ? n = [] : (S && (w = !0), z = e.substring(0, z.length +
                                                    (S ? -1 : 1) * ta(C)), n =
                                                    [z + (l > 3 ? "…" : "")], s.removeChild(s.firstChild))) :
                                            !S || n.length === 1 ? (n = u, u = [], n.length &&
                                                (r++, s = B.createElementNS(Ca, "tspan"), J(s, {dy: y, x: j}), p &&
                                                J(s, "style", p), b.appendChild(s)), q > l && (l = q)) :
                                                (s.removeChild(s.firstChild), u.unshift(n.pop())), n.length &&
                                        s.appendChild(B.createTextNode(n.join(" ").replace(/- /g, "-")));
                                    }
        ...
        rect: function (a, b, c, d, e, f) {
            var e = da(a) ? a.r : e, g = this.createElement("rect"), a = da(a) ? a :
                a === y ? {} : {x: a, y: b, width: u(c, 0), height: u(d, 0)};
            if (f !== y) {
        ...
        image: function (a, b, c, d, e) {
            ...
            f.element.setAttributeNS ? f.element.setAttributeNS("http://www.w3.org/1999/xlink", "href", a) :
        ...
        symbol: function (a, b, c, d, e, f) {
            ...
            if (h) {
                g = this.path(h), x(g, {symbolName: a, x: b, y: c, width: d, height: e}),
                f && x(g, f);
            } else if (i.test(a)) {
                k = function (a, b) {
                    a.element &&
                ...
                }, j = a.match(i)[1], a = Lb[j] || f && f.width && f.height && [f.width, f.height], g =
                    this.image(j).attr({x: b, y: c}), g.isImg = !0, a ? k(g, a) :
                    (g.attr({width: 0, height: 0}), $("img", {
                        onload: function () {
        ...
        symbols: {
            ...
            arc: function (a, b, c, d, e) {
                var f = e.start, c = e.r || c || d, g = e.end -
                    0.001, d = e.innerR, h = e.open, i = X(f), j = aa(f), k = X(g), g = aa(g), e = e.end - f < ma ? 0 : 1;
            ...
            callout: function (a, b, c, d, e) {
                ...
                i = ["M", a + f, b, "L", a + c - f, b, "C", a + c, b, a + c, b, a + c, b + f, "L", a + c, b + d - f, "C", a + c, b + d,
                    a + c, b + d, a + c - f, b + d, "L", a + f, b + d, "C", a, b + d, a, b + d, a, b + d - f, "L", a, b + f, "C", a, b, a,
                    b, a + f, b];
                h && h > c && e > b + g && e < b + d - g ?
                    i.splice(13, 3, "L", a + c, e - 6, a + c + 6, e, a + c, e + 6, a + c, b + d - f) :
                    h && h < 0 && e > b + g && e < b + d - g ? i.splice(33, 3, "L", a, e + 6, a - 6, e, a, e - 6, a, b + f) :
                        e && e > d && h > a + g && h < a + c - g ?
                            i.splice(23, 3, "L", h + 6, b + d, h, b + d + 6, h - 6, b + d, a +
                                f, b + d) :
        ...
        label: function (a, b, c, d, e, f, g, h, i) {
            function j() {
                ...
                if (D) {
                    if (!s) {
                        a = r(-N * t) + B, b = (h ? -A : 0) + B, n.box =
                            s = d ? m.symbol(d, a, b, n.width, n.height, G) : m.rect(a, b, n.width, n.height, 0, G[Qb]), s.attr("fill",
                            P).add(n);
                    }
            ...
            function k() {
                ...
                c = h ? 0 : A;
                if (q(ga) && p && (a === "center" || a === "right")) {
                    b += {center: 0.5, right: 1}[a] * (ga - p.width);
                }
                if (b !== v.x || c !== v.y) {
                    v.attr("x", b), c !== y && v.attr("y", c);
                }
                v.x = b;
                v.y = c
            }
            ...
            var m = this, n = m.g(i), v = m.text("", 0, 0,
                g).attr({zIndex: 1}), s, p, N = 0, t = 3, w = 0, ga, u, Ab, C, B = 0, G = {}, A, D;
            n.onAdd = function () {
                v.add(n);
                ...
                if (b.tagName === "SPAN") {
                    ...
                    if (n !== this.cTT) {
                        ...
                        if (i > m && /[ \-]/.test(b.textContent || b.innerText)) {
                            L(b,
                                {width: m + "px", display: "block", whiteSpace: j && j.whiteSpace || "normal"}), i = m;
                        }
    ...
    if (!ca && !fa) {
        F = {
            ...
            getSpanCorrection: function (a, b, c, d, e) {
                ...
                e && e !== "left" &&
                (this.xCorr -= a * c * (f < 0 ? -1 : 1), d && (this.yCorr -= h * c * (g < 0 ? -1 : 1)), L(this.element, {textAlign: e}))
            },
            pathToVML: function (a) {
                for (var b = a.length, c = []; b--;) {
                    if (ra(a[b])) {
                        ...
                        c[b + 5] === c[b + 7] &&
                        (c[b + 7] += a[b + 7] > a[b + 5] ? 1 : -1), c[b + 6] === c[b + 8] && (c[b + 8] += a[b + 8] > a[b + 6] ? 1 : -1);
                    }
                }
                return c.join(" ") || "x"
            },
        ...
        var Na = {
            ...
            color: function (a, b, c, d) {
                ...
                if (i) {
                    var k, l, m = a.linearGradient || a.radialGradient, n, v, s, p, N, t = "", a = a.stops, w, ga = [], q = function () {
                        h = ['<fill colors="' + ga.join(",") + '" opacity="', s, '" o:opacity2="', v, '" type="', i, '" ', t,
                    ...
                    if (c === "fill") {
                        if (i === "gradient") {
                            c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, n = m.x2 || m[2] || 0, m =
                                m.y2 || m[3] || 0, t = 'angle="' + (90 - W.atan((m - a) / (n - c)) * 180 / ma) + '"', q();
                        } else {
                            var j = m.r, u = j * 2, y = j * 2, r = m.cx, x = m.cy, C = b.radialReference, z, j = function () {
                                C && (z = d.getBBox(), r += (C[0] - z.x) / z.width - 0.5, x += (C[1] - z.y) / z.height - 0.5, u *=
                                    C[2] / z.width, y *= C[2] / z.height);
                    ...
                    f = oa(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], $(this.prepVML(h),
                        null, null, b), j = f.get("rgb");
                } else {
            ...
            prepVML: function (a) {
                ...
                b ? (a = a.replace("/>", ' xmlns="urn:schemas-microsoft-com:vml" />'), a =
                        a.indexOf('style="') === -1 ? a.replace("/>", ' style="display:inline-block;behavior:url(#default#VML);" />') :
    ...
    Ta.prototype = {
        addLabel: function () {
            var a =
                this.axis, b = a.options, c = a.chart, d = a.categories, e = a.names, f = this.pos, g = b.labels, h = a.tickPositions, i = f ===
                h[0], j = f === h[h.length - 1], e = d ? p(d[f], e[f], f) : f, d = this.label, h = h.info, k;
            ...
            q(d) ? d && d.attr({text: b}) : (this.labelLength =
                    (this.label = d = q(b) && g.enabled ? c.renderer.text(b, 0, 0, g.useHTML).css(z(g.style)).add(a.labelGroup) :
        ...
        handleOverflow: function (a) {
            var b = this.axis, c = a.x, d = b.chart.chartWidth, e = b.chart.spacing, f = p(b.labelLeft, C(b.pos, e[3])), e = p(b.labelRight,
                u(b.pos + b.len, d - e[1])), g = this.label, h = this.rotation, i = {
                left: 0,
                center: 0.5,
                right: 1
            }[b.labelAlign], j = g.getBBox().width, k = b.slotWidth, l = 1, m, n = {};
            if (h) {
                h < 0 && c - i * j < f ? m = r(c / X(h * ha) - f) : h > 0 && c + i * j > e && (m = r((d - c) / X(h * ha)));
            } else if (d =
                    c +
                    (1 - i) * j, c - i * j < f ? k = a.x + k * (1 - i) - f : d > e && (k = e - a.x + k * i, l = -1), k =
                    C(b.slotWidth, k), k < b.slotWidth && b.labelAlign === "center" &&
                (a.x += l * (b.slotWidth - k - i * (b.slotWidth - C(j, k)))), j > k || b.autoRotation && g.styles.width) {
                m = k;
            }
            if (m) {
                n.width = m;
        ...
        getPosition: function (a, b, c, d) {
            ...
            return {
                x: a ? e.translate(b + c, null, null, d) + e.transB :
                    e.left + e.offset + (e.opposite ? (d && f.oldChartWidth || f.chartWidth) -
                        e.right - e.left : 0),
        ...
        getLabelPosition: function (a, b, c, d, e, f, g, h) {
            var i = this.axis, j = i.transA, k = i.reversed, l = i.staggerLines, m = i.tickRotCorr || {
                ...
                m.y + (i.side === 2 ? 8 : -(c.getBBox().height / 2))), a = a + e.x + m.x - (f && d ? f * j * (k ? -1 : 1) : 0), b = b +
                c - (f && !d ? f * j * (k ? 1 : -1) : 0);
        ...
        render: function (a,
                          b, c) {
            var d = this.axis, e = d.options, f = d.chart.renderer, g = d.horiz, h = this.type, i = this.label, j = this.pos, k = e.labels, l = this.gridLine, m = h ?
                h + "Grid" : "grid", n = h ? h + "Tick" : "tick", v = e[m + "LineWidth"], s = e[m + "LineColor"], o = e[m +
            "LineDashStyle"], N = e[n + "Length"], m = e[n + "Width"] || 0, t = e[n + "Color"], w = e[n +
            "Position"], n = this.mark, ga = k.step, q = !0, u = d.tickmarkOffset, r = this.getPosition(g, j, u,
                b), x = r.x, r = r.y, z = g && x === d.pos + d.len || !g && r === d.pos ? -1 : 1, c = p(c, 1);
            this.isActive = !0;
            if (v) {
            ...
            if (m && N) {
                w === "inside" && (N = -N), d.opposite && (N = -N), h = this.getMarkPath(x, r, N, m * z, g, f), n ?
                    n.animate({d: h, opacity: c}) :
                    this.mark = f.path(h).attr({stroke: t, "stroke-width": m, opacity: c}).add(d.axisGroup);
            }
            if (i && !isNaN(x)) {
                i.xy = r = this.getLabelPosition(x, r, i, g, k, u, a, ga), this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) ||
                this.isLast && !this.isFirst && !p(e.showLastLabel, 1) ? q = !1 :
                    g && !d.isRadial && !k.step && !k.rotation && !b && c !== 0 && this.handleOverflow(r), ga && a % ga && (q = !1), q && !isNaN(r.y) ? (r.opacity = c, i[this.isNew ? "attr" : "animate"](r), this.isNew = !1) : i.attr("y", -9999)
            }
        },
        destroy: function () {
            Qa(this, this.axis)
    ...
    A.PlotLineOrBand.prototype = {
        render: function () {
            var a = this, b = a.axis, c = b.horiz, d = a.options, e = d.label, f = a.label, g = d.width, h = d.to, i = d.from, j = q(i) &&
                    q(h), k = d.value,
                l = d.dashStyle, m = a.svgElem, n = [], v, s = d.color, p = d.zIndex, o = d.events, t = {}, w = b.chart.renderer;
            b.isLog && (i = Ea(i), h = Ea(h), k = Ea(k));
            if (g) {
                if (n = b.getPlotLinePath(k, g), t = {stroke: s, "stroke-width": g}, l) {
                    t.dashstyle = l
                }
            } else if (j) {
            ...
            if (m) {
                if (n) {
                    m.animate({d: n}, null, m.onGetPath);
                } else {
    ...
    va.prototype = {
        ...
        init: function (a, b) {
            ...
            if (this.isLog) {
                this.val2lin = Ea, this.lin2val = ia
            }
        },
        ...
        defaultLabelFormatter: function () {
            var a = this.axis, b = this.value, c = a.categories, d = this.dateTimeLabelFormat, e = T.lang.numericSymbols, f = e &&
            ...
            if (h) {
                ...
                for (; f-- && g === y;) {
                    c =
                        Math.pow(1E3, f + 1), a >= c && b * 10 % c === 0 && e[f] !== null && (g = A.numberFormat(b / c, -1) + e[f]);
                }
            }
                ...
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        if (d = c.xData, d.length) {
                            a.dataMin = C(p(a.dataMin, d[0]), Pa(d)), a.dataMax = u(p(a.dataMax, d[0]), Fa(d))
                        }
                    } else {
                        c.getExtremes();
                        e = c.dataMax;
        ...
        translate: function (a, b, c, d, e, f) {
            var g = this.linkedParent || this, h = 1, i = 0, j = d ? g.oldTransA : g.transA, d = d ? g.oldMin :
                g.min, k = g.minPixelPadding, e = (g.doPostTranslate || g.isLog && e) && g.lin2val;
            if (!j) {
                j = g.transA;
            }
            if (c) {
            ...
            b ? (a = a * h + i, a -= k, a = a / j + d, e && (a = g.lin2val(a))) :
                (e && (a = g.val2lin(a)), f === "between" && (f = 0.5), a =
                    h * (a - d) * j + i + h * k + (ra(f) ? j * f * g.pointRange : 0));
            return a
        },
        toPixels: function (a,
                            b) {
        ...
        getMinorTickPositions: function () {
            ...
            if (g && g / c < this.len / 3) {
                if (this.isLog) {
                    ...
                    d =
                        d.concat(this.getTimeTicks(this.normalizeTimeTickInterval(c), f, e, a.startOfWeek));
                } else {
                    for (b = f + (b[0] - f) % c;
                         b <= e; b += c) {
                        d.push(b);
        ...
        adjustForMinRange: function () {
            ...
            if (this.isXAxis && this.minRange === y && !this.isLog) {
                q(a.min) || q(a.max) ? this.minRange = null :
        ...
        setAxisTranslation: function (a) {
            var b = this, c = b.max - b.min, d = b.axisPointRange ||
                0, e, f = 0, g = 0, h = b.linkedParent, i = !!b.categories, j = b.transA, k = b.isXAxis;
            if (k || i || d) {
        ...
        setTickInterval: function (a) {
            ...
            h ? (b.linkedParent = c[b.coll][d.linkedTo], c = b.linkedParent.getExtremes(), b.min = p(c.min, c.dataMin), b.max =
                    p(c.max, c.dataMax), d.type !== b.linkedParent.options.type && la(11, 1)) :
                (b.min = p(b.userMin, d.min, b.dataMin), b.max = p(b.userMax, d.max, b.dataMax));
            if (e) {
                !a && C(b.min, p(b.dataMin,
            ...
            b.tickInterval = b.min === b.max || b.min === void 0 || b.max === void 0 ? 1 :
                h && !k && l === b.linkedParent.options.tickPixelInterval ? k = b.linkedParent.tickInterval :
                    p(k, this.tickAmount ? (b.max - b.min) / u(this.tickAmount - 1, 1) : void 0,
                        m ? 1 : (b.max - b.min) * l / u(b.len, l));
            ...
            if (!f && !e && !k) {
                b.tickInterval = qb(b.tickInterval, null, pb(b.tickInterval),
                    p(d.allowDecimals, !(b.tickInterval > 0.5 && b.tickInterval < 5 && b.max > 1E3 && b.max < 9999)), !!this.tickAmount);
            }
        ...
        setTickPositions: function () {
            ...
            if (!b && (this.tickPositions = b = this.isDatetimeAxis ?
                    this.getTimeTicks(this.normalizeTimeTickInterval(this.tickInterval, a.units), this.min, this.max, a.startOfWeek,
                        this.ordinalPositions, this.closestPointRange, !0) :
                    this.isLog ? this.getLogTickPositions(this.tickInterval,
                            this.min, this.max) : this.getLinearTickPositions(this.tickInterval, this.min, this.max), d &&
                (d = d.apply(this, [this.min, this.max])))) {
                this.tickPositions = b = d;
            }
            if (!this.isLinked) {
                this.trimTicks(b, e, f), this.min === this.max && q(this.min) && !this.tickAmount &&
                (g = !0, this.min -= 0.5, this.max += 0.5), this.single = g, !c && !d && this.adjustTickAmount()
            }
        },
        ...
        setAxisSize: function () {
            var a = this.chart, b = this.options, c = b.offsetLeft || 0, d = this.horiz, e = p(b.width,
                a.plotWidth - c + (b.offsetRight || 0)), f = p(b.height, a.plotHeight), g = p(b.top, a.plotTop), b = p(b.left,
                a.plotLeft + c), c = /%$/;
        ...
        unsquish: function () {
            var a = this.ticks, b = this.options.labels,
                c = this.horiz, d = this.tickInterval, e = d, f = this.len / (((this.categories ? 1 : 0) + this.max - this.min) /
                    d), g, h = b.rotation, i = this.chart.renderer.fontMetrics(b.style.fontSize,
            ...
            c ? (l = q(h) ? [h] : f < p(b.autoRotationLimit, 80) && !b.staggerLines && !b.step && b.autoRotation) && o(l, function (a) {
                    var b;
                    if (a === h || a && a >= -90 && a <= 90) {
                        j = m(O(i.h / aa(ha * a))), b = j + O(a / 360), b < k && (k = b, g = a, e = j)
                    }
                }) : e = m(i.h);
            this.autoRotation = l;
        ...
        renderUnsquish: function () {
            var a =
                this.chart, b = a.renderer, c = this.tickPositions, d = this.ticks, e = this.options.labels, f = this.horiz, g = a.margin, h = this.categories ?
                c.length : c.length - 1, i = this.slotWidth =
                f && !e.step && !e.rotation && (this.staggerLines || 1) * a.plotWidth / h ||
                !f && (g[3] && g[3] - a.spacing[3] || a.chartWidth * 0.33), j = u(1,
                r(i - 2 * (e.padding || 5))), k = {}, g = b.fontMetrics(e.style.fontSize,
                d[0] && d[0].label), h = e.style.textOverflow, l, m = 0;
            if (!Da(e.rotation)) {
            ...
            if (this.autoRotation) {
                ...
                for (i = c.length; !f && i--;) {
                    if (j = c[i], j = d[j].label) {
                        if (j.styles.textOverflow === "ellipsis" &&
                            j.css({textOverflow: "clip"}), j.getBBox().height > this.len / c.length - (g.h - g.f)) {
                            j.specCss =
            ...
            if (k.rotation && (l = {width: (m > a.chartHeight * 0.5 ? a.chartHeight * 0.33 : a.chartHeight) + "px"}, !h)) {
                l.textOverflow =
                    "ellipsis";
            }
            ...
            o(c, function (a) {
                var b = (a = d[a]) && a.label;
                if (b) {
                    l && b.css(z(l, b.specCss)), delete b.specCss, b.attr(k), a.rotation = k.rotation
                }
            });
        ...
        getOffset: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ?
                [1, 0, 3, 2][h] :
                h, j, k, l = 0, m, n = 0, v = d.title, s = d.labels, S = 0, N = b.axisOffset, b = b.clipOffset, t = [-1,
                1, 1, -1][h], w;
            j = a.hasData();
            a.showAxis = k = j || p(d.showEmpty, !0);
            a.staggerLines = a.horiz && s.staggerLines;
            if (!a.axisGroup) {
                a.gridGroup = c.g("grid").attr({zIndex: d.gridZIndex || 1}).add(), a.axisGroup =
                    c.g("axis").attr({zIndex: d.zIndex || 2}).add(), a.labelGroup =
                    c.g("axis-labels").attr({zIndex: s.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels").add();
            }
            if (j || a.isLinked) {
                if (o(e, function (b) {
            ...
            if (v && v.text && v.enabled !== !1) {
                ...
                if (k) {
                    l = a.axisTitle.getBBox()[g ? "height" : "width"], m = v.offset, n =
        ...
        getLinePath: function (a) {
            var b = this.chart, c = this.opposite, d = this.offset, e = this.horiz, f = this.left + (c ? this.width : 0) +
                d, d = b.chartHeight - this.bottom - (c ? this.height : 0) + d;
            c &&
            (a *= -1);
            return b.renderer.crispLine(["M", e ? this.left : f, e ? d : this.top, "L", e ? b.chartWidth - this.right : f,
                e ? d : b.chartHeight - this.bottom], a)
        },
        getTitlePosition: function () {
            var a = this.horiz, b = this.left, c = this.top, d = this.len, e = this.options.title, f = a ? b :
                c, g = this.opposite, h = this.offset, i = e.x || 0, j = e.y || 0, k = D(e.style.fontSize || 12), d = {
        ...
        render: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.isLog, f = a.isLinked, g = a.tickPositions, h = a.axisTitle, i = a.ticks, j = a.minorTicks, k = a.alternateBands, l = d.stackLabels, m = d.alternateGridColor, n = a.tickmarkOffset, v = d.lineWidth, s, p = b.hasRendered &&
                q(a.oldMin) && !isNaN(a.oldMin), N = a.showAxis, t, w;
            ...
            if (a.hasData() || f) {
                ...
                if (g.length && (o(g, function (b, c) {
                        if (!f || b >= a.min && b <= a.max) {
                            i[b] || (i[b] = new Ta(a, b)), p && i[b].isNew &&
                            i[b].render(c, !0, 0.1), i[b].render(c)
                        }
                    }), n && (a.min === 0 || a.single))) {
                ...
                m && o(g, function (b, c) {
                    if (c % 2 === 0 && b < a.max) {
                        k[b] || (k[b] = new A.PlotLineOrBand(a)), t = b + n, w =
                            g[c + 1] !== y ? g[c + 1] + n : a.max, k[b].options =
                            {from: e ? ia(t) : t, to: e ? ia(w) : w, color: m}, k[b].render(), k[b].isActive = !0
                    }
                });
                if (!a._addedPlotLB) {
                    o((d.plotLines ||
            ...
            if (v) {
                s = a.getLinePath(v), a.axisLine ? a.axisLine.animate({d: s}) :
                    a.axisLine = c.path(s).attr({stroke: d.lineColor, "stroke-width": v, zIndex: 7}).add(a.axisGroup),
        ...
        drawCrosshair: function (a, b) {
            ...
            if (!this.crosshair || (q(b) || !p(this.crosshair.snap, !0)) === !1 ||
                b && b.series && b.series[this.coll] !== this) {
                this.hideCrosshair();
            } else if (p(d.snap, !0) ?
                    q(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY) :
                    c = this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos, c =
                    this.isRadial ? this.getPlotLinePath(this.isXAxis ? b.x : p(b.stackY, b.y)) || null :
                        this.getPlotLinePath(null, null, null,
                            null, c) || null, c ===
                null) {
                this.hideCrosshair();
            } else if (this.cross) {
    ...
    va.prototype.getTimeTicks = function (a, b, c, d) {
        ...
        if (q(b)) {
            ...
            if (j >= E.second) {
                i[Fb](j >= E.minute ? 0 : k * V(i.getSeconds() / k));
            }
            if (j >= E.minute) {
                i[Gb](j >= E.hour ? 0 : k * V(i[sb]() / k));
            }
            if (j >= E.hour) {
                i[Hb](j >=
                E.day ? 0 : k * V(i[tb]() / k));
            ...
            h = i[Za]();
            for (var d = i.getTime(), l = i[Ya](), m = i[Xa](), n = (E.day + (g ? Wa(i) : i.getTimezoneOffset() * 6E4)) % E.day;
                 d < c;) {
                e.push(d), j === E.year ? d = gb(h + b * k, 0) : j === E.month ? d = gb(h, l + b * k) :
                        !g && (j === E.day || j === E.week) ? d = gb(h, l, m + b * k * (j === E.day ? 1 : 7)) : d += j * k, b++;
            }
            e.push(d);
            o(lb(e,
                function (a) {
    ...
    va.prototype.normalizeTimeTickInterval = function (a, b) {
        var c = b || [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]],
                ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1, 2]], ["week", [1, 2]],
                ["month", [1, 2, 3, 4, 6]], ["year", null]], d = c[c.length - 1], e = E[d[0]], f = d[1], g;
    ...
    va.prototype.getLogTickPositions = function (a, b, c, d) {
        ...
        if (a >= 0.5) {
            ...
            for (var f = V(b), h, i, j, k, l, e = a > 0.3 ?
                [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) {
                i = e.length;
                for (h = 0; h < i && !l; h++) {
                    j = Ea(ia(f) * e[h]), j > b && (!d || k <= c) && k !== y && g.push(k), k > c && (l = !0),
                        k = j
                }
            }
                ...
                qb(a, null, pb(a)), g = Ua(this.getLinearTickPositions(a, b, c), Ea), !d) {
    ...
    Nb.prototype = {
        ...
        move: function (a, b, c, d) {
            var e = this, f = e.now, g = e.options.animation !== !1 && !e.isHidden &&
                (O(a - f.x) > 1 || O(b - f.y) > 1), h = e.followPointer || e.len > 1;
            x(f, {
                x: g ? (2 * f.x + a) / 3 : a,
                y: g ? (f.y + b) / 2 : b,
        ...
        getAnchor: function (a, b) {
            ...
            c || (o(a, function (a) {
                ...
                [e ? d.plotWidth - i : h, this.shared && !e && a.length > 1 && b ? b.chartY - f : e ? d.plotHeight - h : i]);
            return Ua(c, r)
        },
        getPosition: function (a, b, c) {
            var d = this.chart,
                e = this.distance, f = {}, g = c.h || 0, h, i = ["y", d.chartHeight, b, c.plotY + d.plotTop], j = ["x", d.chartWidth, a,
                    c.plotX + d.plotLeft], k = p(c.ttBelow, d.inverted && !c.negative || !d.inverted && c.negative), l = function (a, b,
                                                                                                                                   c, d) {
        ...
        refresh: function (a, b) {
            ...
            j === !1 ? this.hide() : (this.isHidden && (db(d), d.attr("opacity", 1).show()), d.attr({text: j}), l =
                    e.borderColor || a.color || i.color || "#606060", d.attr({stroke: l}),
                    this.updatePosition({
                        plotX: f,
                        plotY: g,
                        negative: a.negative,
        ...
        tooltipFooterHeaderFormatter: function (a, b) {
            var c = b ? "footer" : "header", d = a.series, e = d.tooltipOptions, f = e.xDateFormat, g = d.xAxis, h = g &&
                    g.options.type === "datetime" && ra(a.key),
                c = e[c + "Format"];
    ...
    Va.prototype = {
        init: function (a, b) {
            ...
            if (A.Tooltip && b.tooltip.enabled) {
                a.tooltip = new Nb(a, b.tooltip), this.followTouchMove = p(b.tooltip.followTouchMove, !0);
            }
            this.setDOMEvents()
        },
        ...
        runPointActions: function (a) {
            var b = this.chart, c = b.series, d = b.tooltip, e = d ? d.shared :
                    !1, f = b.hoverPoint, g = b.hoverSeries, h, i = b.chartWidth, j, k, l = [], m,
                n;
            if (!e && !g) {
            ...
            !e && g && g.directTouch && f ? m = f : (o(c, function (b) {
                    ...
                    k = !e && b.directTouch;
                    b.visible && !j && !k && p(b.options.enableMouseTracking, !0) && (n = b.searchPoint(a, !j && b.kdDimensions === 1)) &&
                    l.push(n)
                }), o(l, function (a) {
            ...
            if (m && (m !== this.prevKDPoint || d && d.isHidden)) {
                if (e && !m.series.noSharedTooltip) {
                    for (h = l.length; h--;) {
                        (l[h].clientX !== m.clientX || l[h].series.noSharedTooltip) &&
                        l.splice(h, 1);
                    }
                    ...
                    d && d.refresh(m, a), m.onMouseOver(a);
                }
                this.prevKDPoint = m
            } else {
            ...
            if (d && !this._onDocumentMouseMove) {
                this._onDocumentMouseMove =
                    function (a) {
                        if (Y[pa]) {
                            Y[pa].pointer.onDocumentMouseMove(a)
                        }
        ...
        reset: function (a, b) {
            ...
            if (a) {
                ...
                if (this._onDocumentMouseMove) {
                    Z(B, "mousemove", this._onDocumentMouseMove), this._onDocumentMouseMove =
                        null;
                }
                o(c.axes, function (a) {
                    a.hideCrosshair()
        ...
        drag: function (a) {
            var b = this.chart, c = b.options.chart, d = a.chartX, e = a.chartY, f = this.zoomHor, g = this.zoomVert, h = b.plotLeft, i = b.plotTop, j = b.plotWidth, k = b.plotHeight, l, m = this.mouseDownX, n = this.mouseDownY, v = c.panKey &&
                a[c.panKey + "Key"];
            d < h ? d = h : d > h + j && (d = h + j);
            e < i ? e = i : e > i + k && (e = i + k);
            ...
            if (this.hasDragged > 10) {
                ...
                if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !v && !this.selectionMarker) {
        ...
        drop: function (a) {
            ...
            if (this.selectionMarker) {
                var e = {xAxis: [], yAxis: [], originalEvent: a.originalEvent || a}, f = this.selectionMarker,
                    g = f.attr ? f.attr("x") : f.x, h = f.attr ? f.attr("y") : f.y, i = f.attr ? f.attr("width") : f.width, j = f.attr ?
                        f.attr("height") : f.height, k;
                if (this.hasDragged || d) {
                    o(c.axes, function (c) {
                        if (c.zoomEnabled && q(c.min) && (d || b[{xAxis: "zoomX", yAxis: "zoomY"}[c.coll]])) {
                            var f = c.horiz, n = a.type === "touchend" ? c.minPixelPadding : 0, v = c.toValue((f ? g : h) +
                                n), f = c.toValue((f ? g + i : h + j) - n);
            ...
            if (c) {
                L(c.container, {cursor: c._cursor}), c.cancelClick = this.hasDragged > 10, c.mouseIsDown =
        ...
        onContainerMouseMove: function (a) {
            ...
            (this.inClass(a.target, "highcharts-tracker") || b.isInsidePlot(a.chartX - b.plotLeft, a.chartY - b.plotTop)) && !b.openMenu &&
        ...
        onContainerClick: function (a) {
            ...
            b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ?
                (I(c.series, "click", x(a, {point: c})), b.hoverPoint && c.firePointEvent("click",
    ...
    x(A.Pointer.prototype, {
        ...
        pinchTranslateDirection: function (a,
                                           b, c, d, e, f, g, h) {
            var i = this.chart, j = a ? "x" : "y", k = a ? "X" : "Y", l = "chart" + k, m = a ? "width" : "height", n = i["plot" +
            (a ? "Left" : "Top")], v, s, p = h || 1, o = i.inverted, t = i.bounds[a ? "h" : "v"], w = b.length ===
                1, q = b[0][l], u = c[0][l], r = !w && b[1][l], y = !w && c[1][l], x, c = function () {
        ...
        pinch: function (a) {
            var b = this, c = b.chart, d = b.pinchDown, e = a.touches, f = e.length, g = b.lastValidTouch, h = b.hasZoom, i = b.selectionMarker, j = {}, k = f ===
                1 && (b.inClass(a.target, "highcharts-tracker") && c.runTrackerClick || b.runChartClick), l = {};
            if (f > 1) {
                b.initiated = !0;
            }
            ...
            if (a.type === "touchstart") {
                ...
                if (!i) {
                    b.selectionMarker = i = x({destroy: na}, c.plotBox);
                }
        ...
        touch: function (a, b) {
            var c = this.chart;
            pa = c.index;
            a.touches.length === 1 ? (a = this.normalize(a), c.isInsidePlot(a.chartX - c.plotLeft, a.chartY - c.plotTop) && !c.openMenu ?
                    (b && this.runPointActions(a), this.pinch(a)) : b && this.reset()) : a.touches.length === 2 && this.pinch(a)
        },
    ...
    if (K.PointerEvent || K.MSPointerEvent) {
        var wa = {}, Bb = !!K.PointerEvent,
            Xb = function () {
                ...
                a = a.originalEvent || a;
                if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && Y[pa]) {
                    d(a), d =
                        Y[pa].pointer, d[b]({type: c, target: a.currentTarget, preventDefault: na, touches: Xb()})
                }
            };
        x(Va.prototype, {
    ...
    nb.prototype = {
        init: function (a,
            ...
            if (b.enabled) {
                c.itemStyle = d, c.itemHiddenStyle = z(d, b.itemHiddenStyle), c.itemMarginTop = e, c.padding =
                    ...
                    0, c.symbolWidth = p(b.symbolWidth, 16), c.pages = [], c.render(), H(c.chart, "endResize",
                    function () {
        ...
        renderTitle: function () {
            ...
            if (b.text) {
                if (!this.title) {
                    this.title = this.chart.renderer.label(b.text, a - 3, a - 4, null, null, null, null, null,
        ...
        renderItem: function (a) {
            var b = this.chart, c = b.renderer, d =
                this.options, e = d.layout ===
                "horizontal", f = this.symbolWidth, g = d.symbolPadding, h = this.itemStyle, i = this.itemHiddenStyle, j = this.padding, k = e ?
                p(d.itemDistance, 20) : 0, l = !d.rtl, m = d.width, n = d.itemMarginBottom ||
                0, v = this.itemMarginTop, s = this.initialItemX, o = a.legendItem, q = a.series && a.series.drawLegendSymbol ?
                a.series : a, t = q.options, t = this.createCheckboxForItem && t && t.showCheckbox, w = d.useHTML;
            if (!o) {
                ...
                if (!this.baseline) {
                    this.fontMetrics = c.fontMetrics(h.fontSize, o), this.baseline = this.fontMetrics.f + 3 + v, o.attr("y",
                        this.baseline);
                }
            ...
            if (e && this.itemX - s + f > (m || b.chartWidth - 2 * j - s - d.x)) {
                this.itemX = s, this.itemY +=
                    v + this.lastLineHeight + n, this.lastLineHeight = 0;
            }
        ...
        adjustMargins: function (a, b) {
            ...
            this.display && !d.floating && o([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function (f, g) {
                f.test(e) && !q(a[g]) && (c[jb[g]] = u(c[jb[g]],
                    c.legend[(g + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][g] * d[g % 2 ? "x" : "y"] +
                    p(d.margin, 12) + b[g]))
            })
        },
        render: function () {
            ...
            a.lastItemY = 0;
            if (!d) {
                a.group = d = c.g("legend").attr({zIndex: 7}).add(), a.contentGroup = c.g().attr({zIndex: 1}).add(d), a.scrollGroup =
                    c.g().add(a.contentGroup);
            }
            a.renderTitle();
            e = a.getAllItems();
            rb(e, function (a, b) {
        ...
        handleOverflow: function (a) {
            var b = this, c = this.chart, d = c.renderer, e = this.options, f = e.y, f = c.spacingBox.height +
                ...
                this.padding, g = e.maxHeight, h, i = this.clipRect, j = e.navigation, k = p(j.animation, !0), l = j.arrowSize ||
                12, m = this.nav, n = this.pages, v = this.padding, s, q = this.allItems, N = function (a) {
                i.attr({height: a});
                if (b.contentGroup.div) {
                    b.contentGroup.div.style.clip = "rect(" + v + "px,9999px," + (v + a) + "px,0)"
                }
            };
            ...
            if (a > f) {
                ...
                if (!i) {
                    i = b.clipRect = d.clipRect(0, v, 9999, 0), b.contentGroup.clip(i);
                }
                N(h);
                if (!m) {
                    this.nav = m = d.g().attr({zIndex: 1}).add(this.group), this.up = d.symbol("triangle", 0, 0, l, l).on("click",
                        function () {
                            b.scroll(-1, k)
                ...
                N(c.chartHeight), m.hide(), this.scrollGroup.attr({translateY: 1}), this.clipHeight = 0;
            }
            return a
        },
        scroll: function (a, b) {
            var c = this.pages, d = c.length, e = this.currentPage +
                a, f = this.clipHeight, g = this.options.navigation, h = g.activeColor, g = g.inactiveColor, i = this.pager, j = this.padding;
            e > d && (e = d);
            if (e > 0) {
                b !== y && Sa(b, this.chart),
                    this.nav.attr({
                        ...
                        visibility: "visible"
                    }), this.up.attr({fill: e === 1 ? g : h}).css({cursor: e === 1 ? "default" : "pointer"}), i.attr({
                    text: e + "/" + d
                }), this.down.attr({x: 18 + this.pager.getBBox().width, fill: e === d ? g : h}).css({
                    cursor: e === d ? "default" : "pointer"
                }), c = -c[e - 1] + this.initialItemY, this.scrollGroup.animate({translateY: c}), this.currentPage =
    ...
    Na = A.LegendSymbolMixin = {
        drawRectangle: function (a, b) {
            ...
            b.legendSymbol = this.chart.renderer.rect(0, a.baseline - c + 1, a.symbolWidth, c,
    ...
    F.prototype = {
        ...
        layOutTitles: function (a) {
            ...
            if (c && (c.css({width: (f.width || h) + "px"}).align(x({y: g.fontMetrics(f.style.fontSize, c).b - 3}, f), !1,
                    "spacingBox"), !f.floating && !f.verticalAlign)) {
                b = c.getBBox().height;
            }
            d && (d.css({width: (e.width || h) + "px"}).align(x({y: b + (f.margin - 13) + g.fontMetrics(f.style.fontSize, d).b}, e), !1,
                "spacingBox"), !e.floating && !e.verticalAlign && (b = ta(b + d.getBBox().height)));
        ...
        getChartSize: function () {
            ...
            if (!q(b)) {
                this.containerWidth = kb(c, "width");
            }
            if (!q(a)) {
                this.containerHeight = kb(c, "height");
            }
        ...
        reflow: function (a) {
            var b = this, c = b.options.chart, d = b.renderTo, e = c.width || kb(d, "width"), f = c.height || kb(d, "height"), c = a ?
                a.target : K, d = function () {
                if (b.container) {
        ...
        setSize: function (a, b, c) {
            ...
            if (q(a)) {
                d.chartWidth = e = u(0, r(a)), d.hasUserSize = !!e;
            }
            if (q(b)) {
                d.chartHeight = f = u(0, r(b));
            }
            (za ? mb : L)(d.container, {
                width: e + "px", height: f +
                "px"
        ...
        drawChartBox: function () {
            ...
            if (k) {
                f ? f.animate(t) : this.plotBackground = b.rect(p, o, q, u, 0).attr({fill: k}).add().shadow(a.plotShadow);
            }
            if (l) {
                h ? h.animate(t) :
            ...
            if (m) {
                g ? g.animate(g.crisp({x: p, y: o, width: q, height: u, strokeWidth: -m})) : this.plotBorder =
                        b.rect(p, o, q, u, 0, -m).attr({
        ...
        isReadyToRender: function () {
            var a = this;
            return !ca && K == K.top && B.readyState !== "complete" || fa && !K.canvg ?
                (fa ? Mb.push(function () {
                        a.firstRender()
    ...
    var Yb = A.CenteredSeriesMixin = {
        getCenter: function () {
            var a = this.options,
                b = this.chart, c = 2 * (a.slicedOffset || 0), d = b.plotWidth - 2 * c, b = b.plotHeight -
                    2 * c, e = a.center, e = [p(e[0], "50%"), p(e[1], "50%"), a.size || "100%", a.innerSize || 0], f = C(d,
                b), g, h;
            for (g = 0; g < 4; ++g) {
    ...
    Ga.prototype = {
        init: function (a, b, c) {
            ...
            if (a.options.colorByPoint && (b = a.options.colors || a.chart.options.colors, this.color =
                    this.color || b[a.colorCounter++], a.colorCounter === b.length)) {
                a.colorCounter = 0;
            }
            a.chart.pointCount++;
            return this
    ...
    R.prototype = {
        ...
        autoIncrement: function () {
            ...
            if (d === "month" || d === "year") {
                a = new Aa(b), a = d === "month" ? +a[wb](a[Ya]() + c) : +a[xb](a[Za]() + c), c = a - b;
            }
            this.xIncrement = b + c;
            return b
        },
        ...
        setOptions: function (a) {
            ...
            this.userOptions = a;
            c = z(e, c.series, a);
            this.tooltipOptions = z(T.tooltip, T.plotOptions[this.type].tooltip, b.tooltip, d.series && d.series.tooltip,
        ...
        setData: function (a, b, c, d) {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible) {
                ...
                if (n && h > n) {
                    ...
                    for (c = 0; c < h; c++) {
                        if (a[c] !== y && (i = {series: e}, e.pointClass.prototype.applyOptions.apply(i,
                                [a[c]]), e.updateParallelArrays(i, c), m && i.name)) {
                            l.names[i.x] = i.name;
                        }
                    }
                }
        ...
        processData: function (a) {
            ...
            if (h) a = h.getExtremes(), l = a.min,
                m = a.max;
            if (k && this.sorted && (!i || d > i || this.forceCrop))if (b[d - 1] < l || b[0] > m) b = [], c = []; else if (b[0] < l ||
                b[d - 1] > m) e = this.cropData(this.xData, this.yData, l, m), b = e.xData, c = e.yData, e = e.start, f = !0;
            for (i = b.length - 1; i >= 0; i--)d = b[i] - b[i - 1], d > 0 && (g === y || d < g) ? g = d :
        ...
        generatePoints: function () {
            ...
            for (m = 0; m < g; m++)i = h + m, j ? l[m] = (new f).init(this, [d[m]].concat(sa(e[m]))) :
                (b[i] ? k = b[i] : a[i] !== y && (b[i] = k = (new f).init(this,
                        a[i], d[m])), l[m] = k), l[m].index = i;
            if (b && (g !== (c = b.length) || j))for (m = 0; m < c; m++)if (m === h && !j &&
                (m += g), b[m]) b[m].destroyElements(), b[m].plotX = y;
            this.data = b;
            this.points = l
        },
        getExtremes: function (a) {
            ...
            d = a.length;
            for (l = 0; l < d; l++)if (j = c[l], k = a[l], i = k !== null && k !== y && (!b.isLog || k.length || k > 0), j =
                    this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped ||
                    (c[l + 1] || j) >= g && (c[l - 1] || j) <= h, i && j)if (i = k.length)for (; i--;)k[i] !== null &&
            (e[f++] = k[i]); else e[f++] = k;
            this.dataMin = Pa(e);
            this.dataMax = Fa(e)
        },
        translate: function () {
            ...
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = i ===
                "between" || ra(i), k = a.threshold, l = a.startFromThreshold ? k : 0, m, n, v, o = Number.MAX_VALUE, a = 0; a < g;
                 a++) {
                ...
                if (b && this.visible && w && w[x]) w = w[x], t = w.points[this.index + "," + a], n = t[0], t = t[1], n === l &&
                (n = p(k, e.min)), e.isLog && n <= 0 && (n = null), r.total = r.stackTotal = w.total, r.percentage =
                    w.total && r.y / w.total * 100, r.stackY = t, w.setOffset(this.pointXOffset || 0, this.barW || 0);
        ...
        setClip: function (a) {
            var b = this.chart, c = b.renderer, d = b.inverted, e = this.clipBox, f = e || b.clipBox, g = this.sharedClipKey ||
                ["_sharedClip", a && a.duration, a && a.easing, f.height].join(","), h = b[g], i = b[g + "m"];
            if (!h) {
                if (a) f.width =
            ...
            a ||
            (h.count -= 1, h.count <= 0 && g && b[g] && (e || (b[g] = b[g].destroy()), b[g + "m"] && (b[g + "m"] = b[g + "m"].destroy())))
        },
        animate: function (a) {
        ...
        drawPoints: function () {
            var a, b = this.points, c = this.chart, d, e, f, g, h, i, j, k, l = this.options.marker, m = this.pointAttr[""], n, v, o, r = this.markerGroup, q = p(l.enabled,
                this.xAxis.isRadial, this.closestPointRangePx > 2 * l.radius);
            if (l.enabled !== !1 || this._hasPointMarkers)for (f = b.length; f--;)if (g = b[f], d = V(g.plotX), e = g.plotY, k =
                    g.graphic, n = g.marker || {}, v = !!g.marker, a = q && n.enabled === y ||
                    n.enabled, o = g.isInside, a && e !== y && !isNaN(e) && g.y !== null)if (a =
                    g.pointAttr[g.selected ? "select" : ""] || m, h = a.r, i = p(n.symbol, this.symbol), j =
                    i.indexOf("url") === 0, k) k[o ? "show" : "hide"](!0).animate(x({x: d - h, y: e - h},
        ...
        getAttribs: function () {
            var a = this, b = a.options, c = ba[a.type].marker ? b.marker :
                b, d = c.states, e = d.hover, f, g = a.color, h = a.options.negativeColor;
            f = {stroke: g, fill: g};
            ...
            b.marker ? (e.radius = e.radius || c.radius + e.radiusPlus, e.lineWidth = e.lineWidth || c.lineWidth + e.lineWidthPlus) :
                (e.color = e.color || oa(e.color || g).brighten(e.brightness).get(),
            ...
            if (!j || g < j || l)for (; g--;) {
                ...
                if (l) {
                    ...
                    f = d.hover =
                        d.hover || {};
                    if (!b.marker) f.color = f.color || !j.options.color && e[j.negative && h ? "negativeColor" : "color"] ||
                        oa(j.color).brighten(f.brightness || e.brightness).get();
                    f = {color: j.color};
        ...
        getSegmentPath: function (a) {
            ...
            o(a,
                function (e, f) {
                    ...
                    b.getPointSpline ? c.push.apply(c, b.getPointSpline(a, e, f)) : (c.push(f ? "L" : "M"), d && f &&
                        (i = a[f - 1], d === "right" ? c.push(i.plotX, h) :
                            d === "center" ? c.push((i.plotX + g) / 2, i.plotY, (i.plotX + g) / 2, h) :
        ...
        drawGraph: function () {
            var a = this, b = this.options, c = [["graph",
                b.lineColor || this.color, b.dashStyle]], d = b.lineWidth, e = b.linecap !==
                "square", f = this.getGraphPath(), g = this.fillGraph && this.color || P;
            ...
            o(c, function (c, i) {
                ...
                if (k) db(k), k.animate({d: f}); else if ((d || g) && f.length) k =
                    {stroke: c[1], "stroke-width": d, fill: g, zIndex: 1}, c[2] ? k.dashstyle = c[2] :
                    e && (k["stroke-linecap"] = k["stroke-linejoin"] = "round"), a[j] =
                    a.chart.renderer.path(f).attr(k).add(a.group).shadow(i < 2 &&
                        b.shadow)
            })
        },
        applyZones: function () {
            var a = this, b = this.chart, c = b.renderer, d = this.zones, e, f, g = this.clips ||
                [], h, i = this.graph, j = this.area, k = u(b.chartWidth, b.chartHeight), l = this[(this.zoneAxis || "y") +
            "Axis"], m, n = l.reversed, v = b.inverted, s = l.horiz, q, x, t, w = !1;
            if (d.length && (i || j)) i && i.hide(), j && j.hide(), m = l.getExtremes(), o(d, function (d, o) {
                ...
                b.inverted && c.isVML && (h = l.isXAxis ? {x: 0, y: n ? x : t, height: h.width, width: b.chartWidth} :
        ...
        render: function () {
            var a = this, b = a.chart, c, d = a.options, e = (c = d.animation) && !!a.animate && b.renderer.isSVG && p(c.duration, 500) ||
                0, f = a.visible ? "visible" : "hidden", g = d.zIndex, h = a.hasRendered, i = b.seriesGroup;
    ...
    Ib.prototype = {
        destroy: function () {
            ...
            var c = this.axis, d = c.chart, e = d.inverted, f = c.reversed, f = this.isNegative && !f ||
                    !this.isNegative && f, g = c.translate(c.usePercentage ? 100 : this.total, 0, 0, 0,
                1), c = c.translate(0), c = O(g - c), h = d.xAxis[0].translate(this.x) + a, i = d.plotHeight,
                f = {
                    x: e ? f ? g : g - c : h,
    ...
    R.prototype.setStackedPoints = function () {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            var a = this.processedXData, b = this.processedYData, c = [], d = b.length, e = this.options, f = e.threshold, g = e.startFromThreshold ?
                    f : 0, h = e.stack,
                e = e.stacking, i = this.stackKey, j = "-" +
                    i, k = this.negStacks, l = this.yAxis, m = l.stacks, n = l.oldStacks, o, s, q, r, t, w;
            for (r = 0; r < d; r++) {
                t = a[r];
                w = b[r];
                q = this.index + "," + r;
                s = (o = k && w < (g ? 0 : f)) ? j : i;
                m[s] || (m[s] = {});
                if (!m[s][t]) n[s] && n[s][t] ? (m[s][t] = n[s][t], m[s][t].total = null) :
                    m[s][t] = new Ib(l, l.options.stackLabels, o, t, h);
                s = m[s][t];
                s.points[q] = [p(s.cum, g)];
                e === "percent" ?
                    (o = o ? i : j, k && m[o] && m[o][t] ? (o = m[o][t], s.total = o.total = u(o.total, s.total) + O(w) || 0) :
                        s.total = ea(s.total + (O(w) || 0))) : s.total = ea(s.total + (w || 0));
                s.cum = p(s.cum,
                        g) + (w || 0);
    ...
    R.prototype.setPercentStacks = function () {
        ...
        o([b, "-" + b], function (b) {
            var e;
            for (var f = d.length, g, h; f--;)if (g = d[f], e = (h = c[b] && c[b][g]) && h.points[a.index + "," + f], g = e) h =
                h.total ? 100 / h.total : 0, g[0] = ea(g[0] * h), g[1] = ea(g[1] * h), a.stackedYData[f] = g[1]
        })
    };
    x(F.prototype, {
        addSeries: function (a, b, c) {
            ...
            if (!d) b.loadingDiv = d = $(Ka, {className: "highcharts-loading"},
                x(e.style, {
                    zIndex: 10,
                    display: P
                }), b.container), b.loadingSpan = $("span", null, e.labelStyle, d), H(b, "redraw",
                f);
            b.loadingSpan.innerHTML = a || c.lang.loading;
            if (!b.loadingShown) L(d, {opacity: 0, display: ""}), mb(d, {opacity: e.style.opacity},
    ...
    x(R.prototype, {
        addPoint: function (a, b, c, d) {
            var e = this, f = e.options, g = e.data, h = e.graph, i = e.area, j = e.chart, k = e.xAxis && e.xAxis.names, l = h && h.shift ||
                0, m = ["graph", "area"], h = f.data, n, v = e.xData;
            Sa(d, j);
            if (c) {
        ...
        update: function (a, b) {
            var c = this, d = this.chart, e = this.userOptions, f = this.type, g = M[f].prototype, h = ["group", "markerGroup",
                "dataLabelsGroup"], i;
    ...
    var qa = ka(R, {
        type: "area", getSegments: function () {
            ...
            if (e.stacking && !this.closedStacks)for (d = a.length - 1; d >= 0; d--)g = p(a[d].yBottom, f), d < a.length - 1 && e.step &&
            c.push(a[d + 1].plotX, g), c.push(a[d].plotX, g); else this.closeSegment(c, a, f);
    ...
    xa = ka(R, {
        ...
        getColumnMetrics: function () {
            ...
            var c = C(O(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len), j = c *
                b.groupPadding, k = (c - 2 * j) / i, l = b.pointWidth, b = q(l) ? (k - l) / 2 : k * b.pointPadding, l = p(l, k - 2 * b);
        ...
        translate: function () {
            var a = this, b = a.chart, c = a.options, d = a.borderWidth =
                    p(c.borderWidth, a.closestPointRange * a.xAxis.transA < 2 ? 0 : 1), e = a.yAxis,
                f = a.translatedThreshold = e.getThreshold(c.threshold), g = p(c.minPointLength,
                5), h = a.getColumnMetrics(), i = h.width, j = a.barW = u(i, 1 + 2 * d), k = a.pointXOffset =
                    h.offset, l = -(d % 2 ? 0.5 : 0), m = d % 2 ? 0.5 : 1;
            ...
            o(a.points, function (c) {
                ...
                w = u(h, d) - t;
                O(w) < g && g &&
                (w = g, x = !e.reversed && !c.negative || e.reversed && c.negative, t = r(O(t - f) > g ? d - g : f - (x ? g : 0)));
                c.barX = o;
                c.pointWidth = i;
                q = r(o + q) + l;
                o = r(o) + l;
                ...
                d && (t -= 1, w += 1);
                c.tooltipPos =
                    b.inverted ? [e.len + e.pos - b.plotLeft - h, a.xAxis.len - o - q / 2, w] : [o + q / 2, h + e.pos - b.plotTop, w];
                c.shapeType = "rect";
        ...
        drawPoints: function () {
            ...
            o(a.points, function (h) {
                ...
                if (i !== y && !isNaN(i) && h.y !==
                    null) f = h.shapeArgs, i = q(a.borderWidth) ? {"stroke-width": a.borderWidth} : {}, g =
                    h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], j ?
                    (db(j), j.attr(i)[b.pointCount < e ? "animate" : "attr"](z(f))) : h.graphic =
                        d[h.shapeType](f).attr(i).attr(g).add(a.group).shadow(c.shadow, null,
                            c.stacking && !c.borderRadius); else if (j) h.graphic = j.destroy()
            })
        },
        animate: function (a) {
            ...
            if (ca) a ? (e.scaleY = 0.001, a = C(b.pos + b.len, u(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len :
                    e.translateY = a, this.group.attr(e)) :
                (e.scaleY = 1, e[d ? "translateX" : "translateY"] = b.pos, this.group.animate(e, this.options.animation), this.animate =
                    null)
        },
        remove: function () {
            var a = this, b = a.chart;
    ...
    U = {
        ...
        translate: function (a) {
            ...
            var b = 0, c = this.options, d = c.slicedOffset, e = d + c.borderWidth, f, g, h, i = c.startAngle || 0, j = this.startAngleRad =
                    ma / 180 * (i - 90), i = (this.endAngleRad = ma / 180 * (p(c.endAngle, i + 360) - 90)) -
                    j, k = this.points, l = c.dataLabels.distance, c = c.ignoreHiddenPoint, m,
                n = k.length, o;
            ...
            for (m = 0; m < n; m++) {
                ...
                o.angle = h;
                e = C(e, l / 2);
                o.labelPos = [a[0] + f + X(h) * l, a[1] + g + aa(h) * l, a[0] + f + X(h) * e, a[1] + g + aa(h) * e, a[0] + f, a[1] + g,
        ...
        drawPoints: function () {
            ...
            o(a.points, function (i) {
                ...
                if (d) d.animate(x(g, c)); else {
                    ...
                    i.graphic = d = b[i.shapeType](g).setRadialReference(a.center).attr(i.pointAttr[i.selected ? "select" :
                        ""]).attr(h).attr(c).add(a.group).shadow(e, f)
                }
            })
        },
        searchPoint: na,
    ...
    R.prototype.drawDataLabels = function () {
        ...
        if (d.enabled || a._hasPointLabels) a.dlProcessOptions && a.dlProcessOptions(d), j =
            a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), p(d.defer, !0) &&
        (j.attr({opacity: +h}), h || H(a, "afterAnimate", function () {
            a.visible && j.show();
            ...
            if (n && !h) e.dataLabel = n.destroy(); else if (h) {
                ...
                if (n)if (q(i)) n.attr({text: i}), u = !1; else {
                    ...
                    n = e.dataLabel =
                        k[h ? "text" : "label"](i, 0, -999, d.shape, null, null, d.useHTML).attr(n).css(x(t, w)).add(j).shadow(d.shadow)
                }
    ...
    R.prototype.alignDataLabel = function (a, b, c, d, e) {
        var f = this.chart, g = f.inverted, h = p(a.plotX, -999), i = p(a.plotY,
            -999), j = b.getBBox(), k = f.renderer.fontMetrics(c.style.fontSize).b, l = this.visible &&
            (a.series.forceDL || f.isInsidePlot(h,
                r(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g));
        if (l) d = x({x: g ? f.plotWidth - i : h, y: r(g ? f.plotHeight - h : i), width: 0, height: 0}, d), x(c,
            {
                width: j.width,
                height: j.height
            ...
            (b.align(c, null, d), g = b.alignAttr, p(c.overflow, "justify") === "justify" ? this.justifyDataLabel(b, c, g, j, d, e) :
                p(c.crop, !0) && (l = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + j.width, g.y + j.height)), c.shape &&
    ...
    if (M.pie) M.pie.prototype.drawDataLabels = function () {
        var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = p(e.connectorPadding, 10), g = p(e.connectorWidth,
            1), h = d.plotWidth, i = d.plotHeight, j, k, l = p(e.softConnector, !0), m = e.distance, n = a.center, q = n[2] /
            2, s = n[1], x = m > 0, y, t, w, z = [[], []], B, A, D, F, G, E = [0, 0, 0, 0], L = function (a, b) {
            return b.y - a.y
        };
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            for (F = 2; F--;) {
                ...
                if (K) {
                    ...
                    for (G = 0; G < K; G++) {
                        ...
                        c = w[1];
                        if (m > 0) {
                            if (t = M.pop(), J = t.i, A = t.y, c > A && I[J + 1] !== null || c < A && I[J - 1] !== null) A =
                                C(u(0, c), d.plotHeight)
                        } else A = c;
                        ...
                        if (this.options.size === null) t = y.width, B - t < f ? E[3] = u(r(t - B + f), E[3]) : B + t > h -
                            f && (E[1] = u(r(B + t - h + f), E[1])), A - b / 2 < 0 ? E[0] = u(r(-A + b / 2), E[0]) :
                            A + b / 2 > i && (E[2] = u(r(A + b / 2 - i), E[2]))
                    }
                }
            }
            if (Fa(E) === 0 || this.verifyDataLabelOverflow(E)) this.placeDataLabels(), x && g && o(this.points, function (b) {
                j = b.connector;
                w = b.labelPos;
                if ((y = b.dataLabel) && y._pos && b.visible) D = y._attr.visibility, B = y.connX, A = y.connY, k = l ?
                    ["M", B + (w[6] === "left" ? 5 : -5), A, "C", B, A, 2 * w[2] - w[4], 2 * w[3] - w[5], w[2], w[3], "L", w[4], w[5]] :
                    ["M", B + (w[6] === "left" ? 5 : -5), A, "L", w[2], w[3], "L", w[4], w[5]], j ?
                    (j.animate({d: k}), j.attr("visibility", D)) : b.connector =
        ...
        f < b[2] ? (b[2] = f, b[3] = /%$/.test(c.innerSize || 0) ? f * parseFloat(c.innerSize || 0) / 100 :
                parseFloat(c.innerSize || 0), this.translate(b), o(this.points,
                function (a) {
    ...
    if (M.column) M.column.prototype.alignDataLabel = function (a, b, c, d, e) {
        var f =
            this.chart.inverted, g = a.series, h = a.dlBox || a.shapeArgs, i = p(a.below,
        ...
        if (h && (d = z(h), f &&
            ...
            (d.x += i ? 0 : d.width, d.width = 0) : (d.y += i ? d.height : 0, d.height = 0);
    ...
    (function (a) {
        ...
        b.prototype.hideOverlappingLabels = function (a) {
            ...
            for (d = 0; d < b; d++) {
                e = a[d];
                for (c = d + 1; c < b; ++c)if (k = a[c], e && k && e.placed && k.placed && e.newOpacity !== 0 && k.newOpacity !== 0 && !(k.alignAttr.x > e.alignAttr.x + e.width || k.alignAttr.x + k.width < e.alignAttr.x ||
                    k.alignAttr.y > e.alignAttr.y + e.height || k.alignAttr.y + k.height < e.alignAttr.y)) (e.labelrank < k.labelrank ?
                    e : k).newOpacity = 0
            }
    ...
    U = A.TrackerMixin = {
        drawTrackerPoint: function () {
            ...
            var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath :
                ...
                {cursor: k}, k = a.singlePoints, m, n = function () {
        ...
        showResetZoom: function () {
            ...
            o(b === "xy" ? [1, 0] : [1], function (b) {
                var d = a[b ? "chartX" : "chartY"], h = c[b ? "xAxis" : "yAxis"][0], i = c[b ? "mouseDownX" :
                    "mouseDownY"], j = (h.pointRange || 0) / 2, k = h.getExtremes(), l = h.toValue(i - d, !0) + j, j = h.toValue(i +
        ...
        select: function (a, b) {
            ...
            c.firePointEvent(a ? "select" : "unselect", {accumulate: b}, function () {
                ...
                b || o(e.getSelectedPoints(), function (a) {
                    if (a.selected &&
                        a !== c) a.selected = a.options.selected = !1, d.options.data[Ma(a, d.data)] =
            ...
            if (this.series) this.firePointEvent("mouseOver"), d && (!d.shared || b.noSharedTooltip) &&
            d.refresh(this, a), this.setState("hover"), c.hoverPoint = this
        }, onMouseOut: function () {
            ...
            var c = this.plotX, d = this.plotY, e = this.series, f = e.options.states, g = ba[e.type].marker && e.options.marker, h = g && !g.enabled, i = g && g.states[a], j = i && i.enabled === !1, k = e.stateMarkerGraphic, l = this.marker ||
                {}, m = e.chart, n = e.halo, o, a = a || "";
            o = this.pointAttr[a] ||
                e.pointAttr[a];
            if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 ||
                a && (j || h && i.enabled === !1) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
                if (this.graphic) g = g && this.graphic.symbolName && o.r, this.graphic.attr(z(o,
                    g ? {x: c - g, y: d - g, width: 2 * g, height: 2 * g} : {})), k && k.hide(); else {
                    if (a && i)if (g = i.radius, l = l.symbol || e.symbol, k && k.currentSymbol !== l && (k = k.destroy()), k) k[b ?
                        "animate" : "attr"]({x: c - g, y: d - g}); else if (l) e.stateMarkerGraphic =
                        k = m.renderer.symbol(l, c - g, d - g, 2 * g, 2 * g).attr(o).add(e.markerGroup),
                        k.currentSymbol = l;
                ...
                if ((c = f[a] && f[a].halo) && c.size) {
                    ...
                    n.attr(x({fill: oa(this.color || e.color).setOpacity(c.opacity).get()}, c.attributes))[b ? "animate" :
                        "attr"]({d: this.haloPath(c.size)})
                } else n && n.attr({d: []});
                this.state = a
            }
        }, haloPath: function (a) {
