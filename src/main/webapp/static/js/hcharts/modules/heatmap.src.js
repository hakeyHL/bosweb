        ...
        getDataClassLegendSymbols: function () {
            ...
            if (!legendItems.length) {
                each(this.dataClasses, function (dataClass, i) {
                    ...
                    // Add a com.allbuy.compare.core.persistence.mock object to the legend items
    ...
    var colorSeriesMixin = {
        ...
        translateColors: function () {
            ...
            each(this.data, function (point) {
                ...
                color = value === null ? nullColor :
                    (colorAxis && value !== undefined) ? colorAxis.toColor(value, point) : point.color || series.color;
