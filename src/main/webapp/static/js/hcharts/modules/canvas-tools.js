...
(function () {
    function m() {
        ...
        a.init = function (c) {
            ...
            a.ViewPort = new function () {
                ...
                this.ComputeSize = function (a) {
                    return a != null && typeof a == "number" ? a : a == "x" ? this.width() :
                            a == "y" ? this.height() : Math.sqrt(Math.pow(this.width(), 2) + Math.pow(this.height(), 2)) / Math.sqrt(2)
                }
            }
        };
        a.init();
        ...
        a.Property = function (c, d) {
            ...
            this.Definition = {
                getDefinition: function () {
                    ...
                    return d != null && d.createGradient ? d.createGradient(a.ctx, b) :
            ...
            this.Length = {
                ...
                toPixels: function (d) {
                    ...
                    return c.match(/em$/) ? b.numValue() * this.EM(d) : c.match(/ex$/) ? b.numValue() * this.EM(d) / 2 : c.match(/px$/) ?
                                b.numValue() : c.match(/pt$/) ? b.numValue() * 1.25 : c.match(/pc$/) ? b.numValue() * 15 :
                                        c.match(/cm$/) ? b.numValue() * this.DPI(d) / 2.54 : c.match(/mm$/) ? b.numValue() * this.DPI(d) / 25.4 :
                                                c.match(/in$/) ? b.numValue() * this.DPI(d) :
            ...
            this.Angle = {
                toRadians: function () {
                    ...
                    var a = b.value +
                        "";
                    return a.match(/deg$/) ? b.numValue() * (Math.PI / 180) : a.match(/grad$/) ? b.numValue() * (Math.PI / 200) :
        ...
        a.Font = new function () {
            ...
            this.Parse = function (d) {
                for (var b = {}, d = a.trim(a.compressSpaces(d || "")).split(" "), k = !1, e = !1, f = !1, g = !1, j = "", h = 0;
                     h < d.length; h++) {
        ...
        a.BoundingBox = function (a, d, b, k) {
            ...
            this.addBezierCurve = function (b, a, d, c, k, l, o, n) {
                ...
                for (i = 0; i <= 1; i++) {
                    b = function (b) {
                        return Math.pow(1 - b, 3) * q[i] + 3 * Math.pow(1 - b, 2) * b * p[i] + 3 * (1 - b) * Math.pow(b, 2) * t[i] +
                            Math.pow(b, 3) * m[i]
                    }, a = 6 * q[i] - 12 * p[i] + 6 * t[i], d = -3 * q[i] + 9 * p[i] - 9 * t[i] + 3 * m[i], c = 3 * p[i] - 3 * q[i], d ==
                    0 ?
                        a != 0 && (a = -c / a, 0 < a && a < 1 && (i == 0 && this.addX(b(a)), i == 1 && this.addY(b(a)))) :
                        (c = Math.pow(a, 2) - 4 * c * d, c < 0 || (k =
                            (-a + Math.sqrt(c)) / (2 * d), 0 < k && k < 1 &&
                        (i == 0 && this.addX(b(k)), i == 1 && this.addY(b(k))), a =
                            (-a - Math.sqrt(c)) / (2 * d), 0 < a && a < 1 &&
        ...
        a.AspectRatio = function (c, d, b, k, e, f, g, j, h, l) {
            var d = a.compressSpaces(d), d = d.replace(/^defer\s/, ""), o = d.split(" ")[0] || "xMidYMid", d = d.split(" ")[1] ||
                "meet", n = b / k, q = e / f, p = Math.min(n, q), m = Math.max(n, q);
            d == "meet" && (k *=
                p, f *= p);
            d == "slice" && (k *= m, f *= m);
            ...
            h.hasValue() && l.hasValue() ? c.translate(-p * h.Length.toPixels("x"), -p * l.Length.toPixels("y")) :
                (o.match(/^xMid/) && (d == "meet" && p == q || d == "slice" && m == q) &&
                c.translate(b / 2 - k / 2, 0), o.match(/YMid$/) && (d == "meet" && p == n || d == "slice" && m == n) &&
                c.translate(0, e / 2 - f / 2), o.match(/^xMax/) && (d == "meet" && p == q || d == "slice" && m == q) &&
                c.translate(b - k, 0), o.match(/YMax$/) && (d == "meet" && p == n || d == "slice" && m == n) && c.translate(0, e - f));
            o == "none" ? c.scale(n,
        ...
        a.Element.ElementBase = function (c) {
            ...
            if (c != null && c.nodeType == 1) {
                ...
                for (d = 0; d < c.attributes.length; d++) {
                    b = c.attributes[d], this.attributes[b.nodeName] =
                        new a.Property(b.nodeName, b.nodeValue);
                }
                ...
                if (this.attribute("class").hasValue()) {
                    for (var d = a.compressSpaces(this.attribute("class").value).split(" "), e = 0;
                         e < d.length; e++) {
                        b = a.Styles["." + d[e]];
                        if (b != null) {
                            for (k in b) {
        ...
        a.Element.RenderedElementBase = function (c) {
            ...
            this.setContext = function (d) {
                ...
                if (this.style("stroke").Definition.isUrl()) {
                    ...
                    (b = b.Color.addOpacity(this.style("stroke-opacity").value)), d.strokeStyle =
                ...
                if (typeof d.font != "undefined") {
                    d.font =
                        a.Font.CreateFont(this.style("font-style").value, this.style("font-variant").value,
            ...
            this.renderChildren = function (d) {
                ...
                if (b != null) {
                    ...
                    if (this.style("marker-mid").Definition.isUrl()) {
                        for (var c = this.style("marker-mid").Definition.getDefinition(), e = 1;
                             e < b.length - 1; e++) {
        ...
        a.Element.rect = function (c) {
            ...
            this.path = function (d) {
                ...
                d != null &&
                (d.beginPath(), d.moveTo(b + g, c), d.lineTo(b + e - g, c), d.quadraticCurveTo(b + e, c, b + e, c + j), d.lineTo(b + e,
                    c + f - j), d.quadraticCurveTo(b + e, c + f, b + e - g, c + f), d.lineTo(b + g, c + f), d.quadraticCurveTo(b, c + f,
                    b, c + f - j), d.lineTo(b, c + j), d.quadraticCurveTo(b, c, b + g, c), d.closePath());
        ...
        a.Element.ellipse = function (c) {
            ...
            this.base(c);
            this.path = function (d) {
                var b = 4 * ((Math.sqrt(2) - 1) /
                    3), c = this.attribute("rx").Length.toPixels("x"), e = this.attribute("ry").Length.toPixels("y"), f = this.attribute("cx").Length.toPixels("x"), g = this.attribute("cy").Length.toPixels("y");
                d != null &&
                (d.beginPath(), d.moveTo(f, g - e), d.bezierCurveTo(f + b * c, g - e, f + c, g - b * e, f + c, g), d.bezierCurveTo(f + c,
                    g + b * e, f + b * c, g + e, f, g + e), d.bezierCurveTo(f - b * c, g + e, f - c, g + b * e, f - c,
                    g), d.bezierCurveTo(f - c, g - b * e, f - b * c, g - e, f, g - e), d.closePath());
        ...
        a.Element.line = function (c) {
            ...
            this.getPoints = function () {
                return [new a.Point(this.attribute("x1").Length.toPixels("x"), this.attribute("y1").Length.toPixels("y")),
        ...
        a.Element.path = function (c) {
            ...
            this.PathParser = new function (d) {
                ...
                this.getReflectedControlPoint = function () {
                    return this.previousCommand.toLowerCase() != "c" && this.previousCommand.toLowerCase() != "s" ? this.current :
                ...
                this.getMarkerAngles = function () {
                    for (var b = 0; b < this.angles.length; b++) {
                        if (this.angles[b] == null) {
                            for (var a = b + 1; a < this.angles.length;
                                 a++) {
                    ...
                    switch (b.nextCommand(), b.command.toUpperCase()) {
                        case "M":
                            ...
                            for (b.start = b.current; !b.isCommandOrEnd();) {
                                e = b.getAsCurrentPoint(), b.addMarker(e, b.start), c.addPoint(e.x,
                                    e.y), d != null && d.lineTo(e.x, e.y);
                            }
                            break;
                        case "L":
                        ...
                        case "H":
                            for (; !b.isCommandOrEnd();) {
                                e =
                                    new a.Point((b.isRelativeCommand() ? b.current.x : 0) + b.getScalar(), b.current.y), b.addMarker(e,
                                    b.current), b.current = e, c.addPoint(b.current.x, b.current.y), d != null &&
                        ...
                        case "V":
                            for (; !b.isCommandOrEnd();) {
                                e =
                                    new a.Point(b.current.x, (b.isRelativeCommand() ? b.current.y : 0) + b.getScalar()), b.addMarker(e,
                                    b.current), b.current = e, c.addPoint(b.current.x, b.current.y), d != null &&
                                d.lineTo(b.current.x, b.current.y);
                            }
                            break;
                        ...
                        case "S":
                            for (; !b.isCommandOrEnd();) {
                                g = b.current, f = b.getReflectedControlPoint(), j = b.getAsControlPoint(), e =
                                    b.getAsCurrentPoint(), b.addMarker(e, j, f), c.addBezierCurve(g.x, g.y, f.x, f.y, j.x, j.y, e.x,
                                    e.y), d !=
                                null && d.bezierCurveTo(f.x, f.y, j.x, j.y, e.x, e.y);
                            }
                            break;
                        case "Q":
                            for (; !b.isCommandOrEnd();) {
                                g = b.current, j = b.getAsControlPoint(),
                                    e = b.getAsCurrentPoint(), b.addMarker(e, j, j), c.addQuadraticCurve(g.x, g.y, j.x, j.y, e.x,
                                    e.y), d !=
                                null && d.quadraticCurveTo(j.x, j.y, e.x, e.y);
                            }
                            break;
                        case "T":
                            for (; !b.isCommandOrEnd();) {
                                g = b.current, j = b.getReflectedControlPoint(), b.control = j, e =
                                    b.getAsCurrentPoint(), b.addMarker(e, j, j), c.addQuadraticCurve(g.x, g.y, j.x, j.y, e.x, e.y), d !=
                                null &&
                        ...
                        case "A":
                            for (; !b.isCommandOrEnd();) {
                                var g = b.current, h = b.getScalar(), l = b.getScalar(), f = b.getScalar() *
                                        (Math.PI / 180), o = b.getScalar(), j = b.getScalar(),
                                    e = b.getAsCurrentPoint(), n = new a.Point(Math.cos(f) * (g.x - e.x) / 2 +
                                        Math.sin(f) * (g.y - e.y) / 2,
                                        -Math.sin(f) * (g.x - e.x) / 2 + Math.cos(f) * (g.y - e.y) / 2), q = Math.pow(n.x, 2) /
                                        Math.pow(h, 2) + Math.pow(n.y, 2) / Math.pow(l, 2);
                                q > 1 && (h *= Math.sqrt(q), l *= Math.sqrt(q));
                                o = (o == j ? -1 : 1) * Math.sqrt((Math.pow(h, 2) * Math.pow(l, 2) - Math.pow(h, 2) * Math.pow(n.y, 2) -
                                ...
                                var p = new a.Point(o * h * n.y / l, o * -l * n.x / h), g = new a.Point((g.x + e.x) / 2 + Math.cos(f) *
                                    p.x - Math.sin(f) * p.y, (g.y + e.y) / 2 + Math.sin(f) * p.x + Math.cos(f) * p.y), m = function (b,
                                                                                                                                     a) {
                                    return (b[0] * a[0] + b[1] * a[1]) / (Math.sqrt(Math.pow(b[0], 2) + Math.pow(b[1], 2)) *
                                        Math.sqrt(Math.pow(a[0], 2) + Math.pow(a[1], 2)))
                                }, s = function (b, a) {
                                    return (b[0] * a[1] < b[1] * a[0] ? -1 : 1) * Math.acos(m(b, a))
                                }, o = s([1, 0],
                                    [(n.x - p.x) / h, (n.y - p.y) / l]), q = [(n.x - p.x) / h, (n.y - p.y) / l], p = [(-n.x - p.x) / h,
                                    (-n.y - p.y) / l], n = s(q, p);
                                if (m(q, p) <= -1) {
                                    n = Math.PI;
                                }
                                ...
                                c.addPoint(e.x, e.y);
                                d != null &&
                                (m = h > l ? h : l, e = h > l ? 1 : h / l, h = h > l ? l / h : 1, d.translate(g.x,
                                    g.y), d.rotate(f), d.scale(e,
                                    h), d.arc(0, 0, m, o, o + n, 1 - j), d.scale(1 / e, 1 / h), d.rotate(-f), d.translate(-g.x, -g.y))
                            }
                            break;
                        case "Z":
            ...
            this.getMarkers = function () {
                for (var a = this.PathParser.getMarkerPoints(), b = this.PathParser.getMarkerAngles(), c = [], e = 0; e < a.length;
                     e++)c.push([a[e],
                    b[e]]);
                return c
            }
        ...
        a.Element.linearGradient = function (c) {
            ...
            this.getGradient = function (a, b) {
                var c = b.getBoundingBox(), e = this.gradientUnits == "objectBoundingBox" ?
                    c.x() + c.width() * this.attribute("x1").numValue() : this.attribute("x1").Length.toPixels("x"), f = this.gradientUnits ==
                "objectBoundingBox" ? c.y() + c.height() * this.attribute("y1").numValue() :
                    this.attribute("y1").Length.toPixels("y"), g = this.gradientUnits == "objectBoundingBox" ?
                    c.x() + c.width() * this.attribute("x2").numValue() : this.attribute("x2").Length.toPixels("x"), c = this.gradientUnits ==
                "objectBoundingBox" ? c.y() + c.height() * this.attribute("y2").numValue() : this.attribute("y2").Length.toPixels("y");
        ...
        a.Element.radialGradient = function (c) {
            ...
            this.getGradient = function (a, b) {
                var c = b.getBoundingBox(), e = this.gradientUnits == "objectBoundingBox" ?
                    c.x() + c.width() * this.attribute("cx").numValue() : this.attribute("cx").Length.toPixels("x"), f = this.gradientUnits ==
                "objectBoundingBox" ? c.y() + c.height() * this.attribute("cy").numValue() :
                    this.attribute("cy").Length.toPixels("y"), g = e, j = f;
                this.attribute("fx").hasValue() && (g =
                    this.gradientUnits == "objectBoundingBox" ? c.x() + c.width() * this.attribute("fx").numValue() :
                        this.attribute("fx").Length.toPixels("x"));
                this.attribute("fy").hasValue() &&
                (j = this.gradientUnits == "objectBoundingBox" ? c.y() + c.height() * this.attribute("fy").numValue() :
                    this.attribute("fy").Length.toPixels("y"));
                c = this.gradientUnits == "objectBoundingBox" ? (c.width() + c.height()) / 2 * this.attribute("r").numValue() :
        ...
        a.Element.AnimateBase = function (c) {
            ...
            this.update = function (a) {
                ...
                if (this.duration > this.maxDuration)if (this.attribute("repeatCount").value == "indefinite") this.duration =
                    0; else return this.attribute("fill").valueOrDefault("remove") == "remove" && !this.removed ?
                    (this.removed = !0, this.getProperty().value = this.initialValue, !0) : !1;
                this.duration += a;
                a = !1;
        ...
        a.Element.animateColor =
            function (c) {
                ...
                this.calcValue = function () {
                    ...
                    if (a.ok && b.ok) {
                        var c = a.r + (b.r - a.r) * this.progress(), e = a.g + (b.g - a.g) * this.progress(), a = a.b +
        ...
        a.Element.font = function (c) {
            ...
            for (c = 0; c < this.children.length; c++) {
                ...
                if (d.type == "font-face") this.fontFace = d, d.style("font-family").hasValue() &&
                (a.Definitions[d.style("font-family").value] = this); else if (d.type == "missing-glyph") this.missingGlyph =
                    d; else if (d.type == "glyph") d.arabicForm != "" ?
                    (this.isArabic = this.isRTL = !0, typeof this.glyphs[d.unicode] == "undefined" &&
                    (this.glyphs[d.unicode] = []), this.glyphs[d.unicode][d.arabicForm] = d) : this.glyphs[d.unicode] = d
            }
        };
        ...
        a.Element.text = function (c) {
            ...
            this.renderChildren =
                function (b) {
                    for (var a = this.style("text-anchor").valueOrDefault("start"), c = this.attribute("x").Length.toPixels("x"), d = this.attribute("y").Length.toPixels("y"), j = 0;
        ...
        a.Element.TextElementBase = function (c) {
            ...
            this.renderChildren = function (c) {
                ...
                } else c.strokeStyle != "" && c.strokeText(a.compressSpaces(this.getText()), this.x, this.y), c.fillStyle != "" &&
        ...
        a.Element.image = function (c) {
            ...
            this.renderChildren = function (b) {
                ...
                f == 0 || g == 0 ||
                (b.save(), b.translate(c, d), a.AspectRatio(b, this.attribute("preserveAspectRatio").value, f, this.img.width, g,
                    this.img.height, 0, 0), b.drawImage(this.img, 0, 0), b.restore())
            }
        };
        ...
        a.Element.symbol = function (c) {
            ...
            this.setContext = function (c) {
                ...
                if (this.attribute("viewBox").hasValue()) {
                    ...
                    width = b[2];
                    height = b[3];
                    a.AspectRatio(c, this.attribute("preserveAspectRatio").value, this.attribute("width").Length.toPixels("x"), width,
        ...
        a.Element.style = function (c) {
            ...
            for (var c = c.childNodes[0].nodeValue + (c.childNodes.length > 1 ? c.childNodes[1].nodeValue :
                    ""), c = c.replace(/(\/\*([^*]|[\r\n]|(\*+([^*\/]|[\r\n])))*\*+\/)|(^[\s]*\/\/.*)/gm,
                ""), c = a.compressSpaces(c), c = c.split("}"), d = 0; d < c.length; d++)if (a.trim(c[d]) !=
        ...
        a.Element.feGaussianBlur = function (c) {
            function d(a, c, d, f, g) {
                for (var j = 0; j < g; j++)for (var h = 0; h < f; h++)for (var l = a[j * f * 4 + h * 4 + 3] / 255, o = 0; o < 4; o++) {
                    for (var n = d[0] * (l == 0 ? 255 : a[j * f * 4 + h * 4 + o]) * (l == 0 || o == 3 ? 1 : l), q = 1; q < d.length; q++) {
                        var p = Math.max(h - q, 0), m = a[j * f * 4 + p * 4 + 3] / 255, p = Math.min(h + q, f - 1), p = a[j * f * 4 +
                            p * 4 + 3] / 255, s = d[q], r;
            ...
            this.apply = function (a, c, e, f, g) {
                var e = this.attribute("stdDeviation").numValue(), c = a.getImageData(0, 0, f, g), e = Math.max(e, 0.01), j = Math.ceil(e *
                        4) + 1;
                mask = [];
        ...
        a.CreateElement = function (c) {
            var d = c.nodeName.replace(/^[^:]+:/, ""), d = d.replace(/\-/g, ""), b = null, b = typeof a.Element[d] != "undefined" ?
                new a.Element[d](c) : new a.Element.MISSING(c);
            b.type = c.nodeName;
            return b
        };
        a.load = function (c, d) {
        ...
        a.loadXmlDoc = function (c, d) {
            ...
            var k = a.CreateElement(d.documentElement), e = k.root = !0, f = function () {
                ...
                if (a.opts.ignoreDimensions != !0) {
                    if (k.style("width").hasValue()) c.canvas.width = k.style("width").Length.toPixels("x"), c.canvas.style.width =
                        c.canvas.width + "px";
            ...
            a.intervalID = setInterval(function () {
                ...
                if (a.opts.ignoreAnimation != !0)for (var c = 0; c < a.Animations.length; c++)b |=
                    a.Animations[c].update(1E3 / a.FRAMERATE);
        ...
        a.Mouse = new function () {
            ...
            this.runEvents = function () {
                ...
                for (var c = 0; c < this.events.length; c++)for (var d = this.events[c], b = this.eventElements[c]; b;)d.run(b), b =
                    b.parent;
                this.events = [];
                this.eventElements = []
            }
    ...
    this.canvg = function (a, c, d) {
        if (a == null && c == null && d == null)for (var c = document.getElementsByTagName("svg"), b = 0; b < c.length; b++) {
            ...
            k.appendChild(a);
            canvg(d, k.innerHTML)
        } else d = d || {}, typeof a == "string" && (a = document.getElementById(a)), a.svg == null ? (b = m(), a.svg = b) :
            (b = a.svg, b.stop()), b.opts = d, a = a.getContext("2d"), typeof c.documentElement != "undefined" ? b.loadXmlDoc(a, c) :
...
(function (m) {
    ...
    b(c.prototype, {
        create: function (a, b, c, d) {
            ...
            var c = this, d = b.options.tooltip, f = d.borderWidth, g = c.ttDiv, m = d.style, p = c.ttLine, t = parseInt(m.padding,
                10), m = k(m, {
                padding: t + "px",
