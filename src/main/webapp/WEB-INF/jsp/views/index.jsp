...
<div id="container">
    <div class="col-md-5 col-md-offset-4">
        <div style="margin: 20px; font-size: 18px">
            <span>首页下单</span>
            <span><a href="${pageContext.request.contextPath }/order/to/list">查看订单?</a></span>
        </div>
        <form id="defaultForm" class="form-horizontal" action="${pageContext.request.contextPath }/order/add"
              method="post">
